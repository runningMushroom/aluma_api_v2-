...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("alumaApi.Models.ApplicationsModel", b =>
                {
                    ...
                    b.Property<bool>("AllowSignature")
                        .HasColumnType("bit");

                    b.Property<bool>("BankValidationComplete")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("PrimaryFormsComplete")
                        .HasColumnType("bit");

                    b.Property<bool>("SecondaryFormsComplete")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("alumaApi.Models.BrokerDetailsModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2020, 9, 9, 8, 56, 50, 597, DateTimeKind.Local).AddTicks(8940),
                            EmploymentDate = new DateTime(2019, 9, 9, 8, 56, 50, 598, DateTimeKind.Local).AddTicks(6850),
                            Modified = new DateTime(2020, 9, 9, 8, 56, 50, 597, DateTimeKind.Local).AddTicks(9002),
                            PostalCode = "0184",
                            StreetName = "Joan",
                            StreetNo = "30",
                            Suburb = "La Montagne",
            ...
            modelBuilder.Entity("alumaApi.Models.Schedules.PrimaryTrust.TrustAddressItemsModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("TrustDetailsId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TrustDetailsId");

                    b.ToTable("primary_schedule_trust_details_address_items");
                });

            modelBuilder.Entity("alumaApi.Models.Schedules.PrimaryTrust.TrustBankDetailsModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("primary_schedule_trust_bank_details");
                });

            modelBuilder.Entity("alumaApi.Models.Schedules.PrimaryTrust.TrustDetailsModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("InCareAddress")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("primary_schedule_trust_details");
                });

            modelBuilder.Entity("alumaApi.Models.Schedules.PrimaryTrust.TrustEntityModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("AwaitingGiin")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ComplaintFi")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("DocumentedTrust")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("EntityName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ExemptOwner")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("FatchaPartner")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("GlobalIntermediaryId")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("GovernmentEntityTrue")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("HightPassive")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ManaginInstitutionCountry")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ManaginInstitutionGiin")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ManaginInstitutionName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("Modified")
                        .HasColumnType("datetime2");

                    b.Property<string>("NfeDirectName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NfeDirectTrue")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NfeInternationalTrue")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NfeLiquidatingTrue")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NfeTreasuryTrue")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NonParticipating")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NonProfit")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NonProfitDetails")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NonReporting")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("OwnerDocumented")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("RegularTradeRelationTrue")
                        .HasColumnType("nvarchar(max)");

                    b.Property<Guid>("ScheduleId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("SponsorGiin")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("primary_schedule_trust_entity_classification");
                });

            modelBuilder.Entity("alumaApi.Models.Schedules.PrimaryTrust.TrustTaxResidencyItemModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("TrustTaxResidencyId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("TrustTaxResidencyId");

                    b.ToTable("primary_schedule_trust_tax_residency_item");
                });

            modelBuilder.Entity("alumaApi.Models.Schedules.PrimaryTrust.TrustTaxResidencyModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("AnyUsPersons")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("Created")
                        .HasColumnType("datetime2");

                    b.Property<string>("InternationalObligations")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("Modified")
                        .HasColumnType("datetime2");

                    b.Property<string>("PersonUsTaxObligations")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("TrustUsTaxObligations")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("UsJurisdiction")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("UsOther")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("UsRegistered")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("primary_schedule_trust_tax_residency");
                });

            modelBuilder.Entity("alumaApi.Models.Schedules.PrimaryTrustModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("primary_schedule_trust");
                });
            ...
            modelBuilder.Entity("alumaApi.Models.UserModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2020, 9, 9, 8, 56, 50, 575, DateTimeKind.Local).AddTicks(9624),
                            ...
                            MobileVerified = true,
                            Modified = new DateTime(2020, 9, 9, 8, 56, 50, 576, DateTimeKind.Local).AddTicks(533),
                            Password = "9068.i5erJMraArjUw/AP37T/eA==.z82bfjGgTlvZc82sa4wkRRYPHYAwK2oXp50a8O7Wr0s=",
                            Role = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("alumaApi.Models.Schedules.PrimaryTrust.TrustAddressItemsModel", b =>
                {
                    b.HasOne("alumaApi.Models.Schedules.PrimaryTrust.TrustDetailsModel", "TrustDetails")
                        .WithMany("AdressItems")
                        .HasForeignKey("TrustDetailsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("alumaApi.Models.Schedules.PrimaryTrust.TrustBankDetailsModel", b =>
                {
                    b.HasOne("alumaApi.Models.Schedules.PrimaryTrustModel", "Schedule")
                        .WithOne("BankDetails")
                        .HasForeignKey("alumaApi.Models.Schedules.PrimaryTrust.TrustBankDetailsModel", "ScheduleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("alumaApi.Models.Schedules.PrimaryTrust.TrustDetailsModel", b =>
                {
                    b.HasOne("alumaApi.Models.Schedules.PrimaryTrustModel", "Schedule")
                        .WithOne("Details")
                        .HasForeignKey("alumaApi.Models.Schedules.PrimaryTrust.TrustDetailsModel", "ScheduleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("alumaApi.Models.Schedules.PrimaryTrust.TrustEntityModel", b =>
                {
                    b.HasOne("alumaApi.Models.Schedules.PrimaryTrustModel", "Schedule")
                        .WithOne("Entity")
                        .HasForeignKey("alumaApi.Models.Schedules.PrimaryTrust.TrustEntityModel", "ScheduleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("alumaApi.Models.Schedules.PrimaryTrust.TrustTaxResidencyItemModel", b =>
                {
                    b.HasOne("alumaApi.Models.Schedules.PrimaryTrust.TrustTaxResidencyModel", "TrustTaxResidency")
                        .WithMany("TaxResidencyItems")
                        .HasForeignKey("TrustTaxResidencyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("alumaApi.Models.Schedules.PrimaryTrust.TrustTaxResidencyModel", b =>
                {
                    b.HasOne("alumaApi.Models.Schedules.PrimaryTrustModel", "Schedule")
                        .WithOne("TaxResidency")
                        .HasForeignKey("alumaApi.Models.Schedules.PrimaryTrust.TrustTaxResidencyModel", "ScheduleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
